...
export function TierBadge({ tier }: { tier: number }) {
  return (
    <span
      className={cn(
        "gt-sheen seal-sheen inline-flex shrink-0 items-center rounded-md border px-2 py-0.5 text-[10px] font-semibold uppercase tracking-[0.08em] shadow-[inset_0_1px_0_oklch(1_0_0/0.6),0_1px_1px_oklch(0.2_0.02_264/0.06)]",
